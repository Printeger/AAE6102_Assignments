...
if (fid > 0)
    ...
    % %% Implement Extended Kalman Filter for positioning =======================
    % disp('   Implementing Extended Kalman Filter for positioning...');
    % [ekfSolutions] = my_EKF(trackResults, settings, navSolutions, eph);
    % 
    % % Compare EKF solutions with least squares solutions
    % plotPositionComparison(navSolutions, ekfSolutions);
    % 
